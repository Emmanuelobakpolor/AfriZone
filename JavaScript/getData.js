...
function displayProducts(){
    ...
    for(let i=0;i<productsContainer.length;i++ ){
        ...
        <div class="product-card" data-id="${productsContainer[i].id}">
            <div class="card-img">
                <img src="${productsContainer[i].images[0]}" alt="${productsContainer[i].name}" onclick="displayDetails(${productsContainer[i].id})">
            ...
            <div class="card-info">
                ...
                <div class="card-meta">
                    <span class="product-price">${productsContainer[i].price}</span>
                    <button class="card-quick-view" onclick="displayDetails(${productsContainer[i].id})">Quick View</button>
                </div>
            </div>
        </div>`
    }
